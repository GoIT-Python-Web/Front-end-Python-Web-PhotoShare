...
// import { useScrollLock } from "../../../../helpers/hooks/useScrollLock";
// import Modal from "../../../modals/modal/Modal.jsx";
// import { banUser, toggleUserRole } from "../../../../store/users/operations";
...
//   const handleRoleChange = () => {
//     dispatch(toggleUserRole(id)); // Зміна ролі користувача
//     setShowModal(false);
//   };

//   const handleBan = () => {
//     dispatch(banUser(id)); // Забанити користувача
//     setShowModal(false);
//   };

//   const handleDelete = () => {
//     if (onDelete) {
//       onDelete(id); // Викликаємо onDelete для видалення користувача
//     }
//     setShowModal(false);
//   };
